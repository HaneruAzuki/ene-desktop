...
const EXTRACTION_SYSTEM = [
  ...
  '- userName は会話で名前が分かったときだけ。userNameReading は読み(かな)が分かったときだけ。',
  '- userBirthday は誕生日が会話で確定したときだけ({month,day} 必須・year は言われたときのみ)。推測で埋めない。',
  '- 名前・誕生日が既存の記憶と食い違うときは、本人が会話の中で訂正を明確に認めた場合に限り更新する。',
