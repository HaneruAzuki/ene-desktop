...
> **方針転換(2026-06)**:キャラは**一人に固定(魚川トリミ)**、キャラ自身の**人生記憶**を持ち、
> 会話が想起にバイアスをかける**心**を持つ。詳細は `docs/archive/design-revision-character-heart.md`。
> 旧「複数キャラ対応・配布PF(Phase5)」は破棄。
...
> - task_15 のデータモデルは `docs/archive/design-revision-memory-v2.md`(§3.3/§5.2 改訂案)に定義。
